...
all: tty.o string.o desc.o int.o start_sys.o start_kernel.o keyboard.o timer.o
	@echo "Linking to flat bin file kernel-2001"
	ld -m elf_i386 -T link.ld -o kernel-2001 start_sys.o tty.o start_kernel.o string.o gdt.o gdt_l.o int.o int_.o keyboard.o timer.o
